...
function Footer() {
  ...
  return (
    <motion.footer className="footer" id="contact" style={{ y }}>
      ...
      <div className="form">
        <p>Make your ideas come to life, contact me!</p>
        ...
        <form
          action={`mailto:albertpatrsu@gmail.com?subject=Contact portfolio from ${name}&body=${message}`}
          method="post"
        >
          <input
