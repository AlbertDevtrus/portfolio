...
export function GithubIcon({speed, color = 'black'}) {
    return (
        <svg width="35" height="35" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" data-scroll data-scroll-speed={speed}>
            ...
            <path d="M11.25 25.0337C7.5 26.2499 4.375 25.0337 2.5 21.2837" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}

export function TwitterIcon({speed, color = 'black'}) {
    return (
        <svg width="30" height="30" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg" data-scroll data-scroll-speed={speed}>
            <path d="M20.2335 14.7154L32.8901 0.318848H29.8903L18.9036 12.8187L10.1243 0.318848H0L13.274 19.2228L0 34.3188H2.99978L14.6039 21.1171L23.8757 34.3188H34L20.2335 14.7154ZM16.1263 19.388L14.7814 17.5058L4.0797 2.52885H8.68686L17.3212 14.6158L18.6661 16.498L29.8928 32.2108H25.2856L16.1263 19.388Z" fill={color}/>
        </svg>
    )
}
...
export function LogoIcon({size = 30}) {
    ...
    return (
        ...
        <svg width={size} height={size} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <line y1="-0.5" x2="18.0723" y2="-0.5" transform="matrix(-0.999996 0.00266613 -0.00289573 -0.999996 30 0)" stroke="black"/>
            <path d="M5.7832 5.54932H24.217V24.451H5.7832V5.54932Z" fill="black"/>
        </svg>
    )
}